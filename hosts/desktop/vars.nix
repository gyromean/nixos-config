{
  ...
  polybarBrightness = ''python ~/.config/custom/polybar-scripts/brightness-desktop.py "$polybar_pid" "$m" &'';
  polybarI3Workspaces = ''python ~/.config/custom/polybar-scripts/i3-workspaces.py "$polybar_pid" "$m" DP-0 DP-4 DP-2 &'';
  speakersSink = "alsa_output.pci-0000_0b_00.4.analog-stereo";
  workspaceSetup = ''
